...
<div class="container">
  ...
  <div class="table-box">
    <div class="table-title">주문 목록</div>
    ...
    <div class="order-table">
      ...
      <div class="row">
        ...
        <div class="col">주문1<br><span class="sub">무슨무슨 커피빈</span></div>
      ...
      <div class="row">
        ...
        <div class="col">주문2<br><span class="sub">무슨무슨 커피빈</span></div>
      ...
      <div class="row">
        ...
        <div class="col">주문3<br><span class="sub">무슨무슨 커피빈</span></div>
      ...
      <div class="row">
        ...
        <div class="col">주문4<br><span class="sub">무슨무슨 커피빈</span></div>
